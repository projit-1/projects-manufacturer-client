    ...
    return (
        <div className='flex justify-center items-center h-screen '>
            ...
            <div class="card w-96 bg-base-100 shadow-xl">
                <div class="card-body">
                    <h2 className='text-center text-2xl text-blue-500'>Sign up</h2>
                    ...
                    <p> <small> Already have an account? <Link className='text-primary' to='/login'> Please login
                    </Link>
                    </small> </p>
